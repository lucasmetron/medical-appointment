...
import { createReturnDoctorsNode } from "./nodes/returnDoctors.ts";
...
const AppointmentStateAnnotation = z.object({
  ...
  intent: z.enum(["schedule", "cancel", "unknown", "returnDoctors"]).optional(),
...
export function buildAppointmentGraph(
  ...
  const workflow = new StateGraph({
    ...
    .addNode("returnDoctors", createReturnDoctorsNode(appoinmentService))
    ...
    .addConditionalEdges(
      ...
      },
      {
        ...
        cancel: "cancel",
        message: "message",
        returnDoctors: "returnDoctors",
      },
    )

    .addEdge("schedule", "message")
    .addEdge("returnDoctors", "message")
